...
| TD-036 | Native scaffolding (gradlew, Runner.xcodeproj, res/, Assets.xcassets, etc.) was hand-curated and incomplete — the repo could not build without running flutter create manually first | High | Version the full native scaffolding, reconciled against the already-tracked com.homesync.app package/bundle id | Resolved (commit 1) | TBD | 2026-08-11 |

...
| TD-027 | Frontend repositories broken against paginated backend (data array → object) | Medium | Paginated envelope + per-tab filtering (?status= query param) + per-tab ScrollController + total visible in header | UX polish completed (commit 1) | TBD | 2026-08-10 |
